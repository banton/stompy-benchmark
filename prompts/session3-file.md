# Session 3 — Scope Change: Multi-Leg Routing (File Memory Condition)
...
1. **Read `MEMORY.md`** in the project root. It contains architecture decisions, implementation details, and conventions from the previous two sessions.
2. **Read `TASKS.md`** in the project root. It lists remaining work items and completed tasks.
3. Read `SPEC.md` for reference, but note that the spec has been **updated** with a new section on multi-leg routing.

Address any critical open tasks from TASKS.md before starting the new feature.
...
- Multi-leg routing implementation details
- New table schema and relationships
- Leg state machine and how it interacts with shipment state machine
- New endpoint patterns
- Test patterns for multi-leg flows

**Update `TASKS.md`** with:
- Mark completed tasks as DONE
- Note any remaining edge cases or improvements
- Final status summary of the entire project
